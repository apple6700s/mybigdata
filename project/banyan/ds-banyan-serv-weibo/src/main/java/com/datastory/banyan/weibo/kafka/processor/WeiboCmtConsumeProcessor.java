...
import com.datastory.banyan.weibo.hbase.PhoenixWbCommentWriterV1;
...
public class WeiboCmtConsumeProcessor extends CountUpLatchBlockProcessor {
    ...
    public void _process(Object _p) {
        try {
            ...
            PhoenixWbCommentWriterV1.getInstance().batchWrite(cmt);
    ...
    public void cleanup() {
        if (getProcessedSize() > 0) {
            ...
            PhoenixWbCommentWriterV1.getInstance().flush();
            if (complex) {
