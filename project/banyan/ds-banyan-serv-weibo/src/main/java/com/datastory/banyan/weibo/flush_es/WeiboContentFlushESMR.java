...
//        scan.setStartRow("0001090925883987".getBytes()).setStopRow("0002011103092332050234".getBytes());
    ...
    public static class WeiboContentScanMapper extends ScanMapper {
        ...
        public Params mapDoc(Params hbDoc) {
            return new WbCntHb2ESDocMapper(hbDoc).map();
        }
        ...
        protected void map(ImmutableBytesWritable key, Result value, Context context) throws IOException, InterruptedException {
            ...
            String selfContent = hbDoc.getString("self_content");
            if (StringUtil.isNullOrEmpty(selfContent) && !StringUtil.isNullOrEmpty(hbDoc.getString("content"))) {
                selfContent = SelfContentExtractor.extract(hbDoc.getString("content"));
    ...
    public static class WeiboContentFlushReducer extends FlushESReducer {
        ...
        public ESWriterAPI getESWriter() {
            return WbCntESWriter.getFlushInstance(Tables.ES_WB_IDX, 5000).setSyncMode();
        }
    }
}
