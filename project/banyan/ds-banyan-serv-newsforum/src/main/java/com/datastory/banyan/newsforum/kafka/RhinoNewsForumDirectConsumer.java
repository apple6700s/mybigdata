...
/**
 * com.datastory.banyan.newsforum.kafka.RhinoNewsForumDirectConsumer
 *
 * @author lhfcws
 * @since 16/11/24
 */

public class RhinoNewsForumDirectConsumer extends IKafkaDirectReader {
    @Override
...
//        sparkConf.put("spark.streaming.backpressure.enabled", "false");
    ...
    public static void main(String[] args) throws Exception {
        ...
        new RhinoNewsForumDirectConsumer().run();
