...
/**
 * com.datastory.banyan.newsforum.kafka.RhinoNewsForumConsumerBushu
 *
 * @author lhfcws
 * @since 16/11/24
 */

public class RhinoNewsForumConsumerBushu extends IKafkaReader {
    @Override
...
//        sparkConf.put("spark.streaming.backpressure.enabled", "false");
    ...
    public static void main(String[] args) throws Exception {
        ...
        new RhinoNewsForumConsumerBushu().run();
