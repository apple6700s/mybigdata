 ...
 * Scan scan = new Scan();
 * TableMapReduceUtil.initTableSnapshotMapperJob(oriTableName,
 ...
 * TableInputFormat an InputSplit is created per region. The region is opened for reading
...
public class TableSnapshotInputFormat extends InputFormat<ImmutableBytesWritable, Result> {
    ...
    public static class TableSnapshotRegionSplit extends InputSplit implements Writable {
        ...
        public TableSnapshotRegionSplit() {
            ...
            LOG.info("[TableDescriptor] " + delegate.getTableDescriptor());
            if (delegate.getTableDescriptor() != null)
                oriTableName = Bytes.toString(delegate.getTableDescriptor().getTableName().getName());
        }
        ...
        public TableSnapshotRegionSplit(HTableDescriptor htd, HRegionInfo regionInfo,
            ...
            oriTableName = Bytes.toString(htd.getTableName().getName());
        }
        ...
        public void write(DataOutput out) throws IOException {
            delegate.write(out);
            out.writeUTF(oriTableName);
        }

        @Override
        public void readFields(DataInput in) throws IOException {
            delegate.readFields(in);
            oriTableName = in.readUTF();
        }
    }
        ...
        public boolean nextKeyValue() throws IOException, InterruptedException {
            ...
            if (result) {
                ...
                if (scanMetrics != null && context != null) {
                    updateCounters(scanMetrics, 0, getCounter, context, 0);
                }
            }
            return result;
        }
