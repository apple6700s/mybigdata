...
public class TableSnapshotInputFormatImpl {
  ...
  public static final Log LOG = LogFactory.getLog(org.apache.hadoop.hbase.mapreduce.TableSnapshotInputFormatImpl.class);
  ...
  public static class InputSplit implements Writable {
    ...
    public InputSplit(HTableDescriptor htd, HRegionInfo regionInfo, List<String> locations,
      ...
      try {
        this.scan = scan != null ? ConfigurationUtil.convertScanToString(scan) : "";
      } catch (IOException e) {
  ...
  public static class RecordReader {
    ...
    public void initialize(InputSplit split, Configuration conf) throws IOException {
      this.scan = ConfigurationUtil.convertStringToScan(split.getScan());
      this.split = split;
  ...
  public static Scan extractScanFromConf(Configuration conf) throws IOException {
    ...
    if (conf.get(TableInputFormat.SCAN) != null) {
      scan = ConfigurationUtil.convertStringToScan(conf.get(TableInputFormat.SCAN));
