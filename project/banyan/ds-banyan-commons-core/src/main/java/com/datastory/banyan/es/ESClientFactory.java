...
//        return createSimpleClient(indexName, indexType, bulkNum);
    ...
    public static BanyanEsBulkClient createBanyanEsBulkClient(String[] esHosts, String indexName, String indexType, int bulkNum) {
        return new BanyanEsBulkClient(CLUSTER_NAME, indexName, indexType, esHosts, bulkNum);
    }

    public static BanyanEsBulkClient createBanyanEsBulkClient(String[] esHosts, String clusterName, String indexName, String indexType, int bulkNum) {
        return new BanyanEsBulkClient(clusterName, indexName, indexType, esHosts, bulkNum);
    }
}
