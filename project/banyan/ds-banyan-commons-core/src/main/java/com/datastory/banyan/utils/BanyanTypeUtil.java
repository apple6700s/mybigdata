...
public class BanyanTypeUtil {
    ...
    public static void putAllNotNull(Map<String, Object> out, Map<String, ? extends Object> in) {
        if (in != null)
            for (Map.Entry<String, ? extends Object> e : in.entrySet()) {
                if (e.getValue() != null)
                    out.put(e.getKey(), e.getValue());
            }
    }

    public static void putAllNotNull(Map<String, Object> out, Map<String, ? extends Object> in, String[] fields) {
        if (in != null) {
    ...
    public static void putAllNotNull(Map<String, Object> out, Map<String, ? extends Object> in, Map<String, String> mappingFields) {
        if (in != null) {
    ...
    public static void putAllStrNotNull(Map<String, Object> out, DocMapper in, Map<String, String> mappingFields) {
        if (in != null) {
            for (Map.Entry<String, String> e : mappingFields.entrySet()) {
                String value = in.getString(e.getKey());
                if (value != null) {
    ...
    public static <T> T safeGet(T[] arr, int i) {
        return safeGet(arr, i, null);
    }

    public static <T> T safeGet(List<T> arr, int i) {
        return safeGet(arr, i, null);
    }

    public static <T> T safeGet(T[] arr, int i, T dft) {
        if (arr == null || arr.length == 0) return dft;
    ...
    public static <T> T safeGet(List<T> arr, int i, T dft) {
        if (arr == null || arr.size() == 0) return dft;
    ...
    public static Params objArr2strMap(Object[] arr) {
        Params p = new Params();
        if (arr != null && arr.length % 2 == 0)
            for (int i = 0; i < arr.length; i += 2) {
                p.put(String.valueOf(arr[i]), arr[i + 1]);
            }
        return p;
    }

    public static StrParams json2strMap(String json) {
        if (json != null) {
            StrParams p = GsonSerializer.deserialize(json.trim(), StrParams.class);
    ...
    public static String prettyStringifyMap(Map<? extends Object, ? extends Object> mp) {
        ...
        if (mp != null)
            for (Map.Entry<? extends Object, ? extends Object> e : mp.entrySet()) {
    ...
    public static String sub1PK(String id) {
        return Md5Util.md5(id).charAt(0) + id;
    }
...
//        return Md5Util.md5(uid).substring(0, 2) + uid;
    ...
    public static boolean valid(Map p) {
        return p != null && !p.isEmpty();
    }

    public static boolean valid(Collection p) {
        return p != null && !p.isEmpty();
    }

    public static <T> boolean valid(T[] p) {
    ...
    public static <T> T getOrElse(Map<String, Object> mp, String key, T dftValue) {
        Object v = mp.get(key);
        if (v == null) {
            return dftValue;
        } else
    ...
    public static String getStrOrElse(Map<String, Object> mp, String key, String dftValue) {
        Object v = mp.get(key);
        if (v == null) {
            return dftValue;
        } else
