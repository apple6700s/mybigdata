...
public class BanyanTables {
    ...
    public static String[] WEIBO_FIELDS = {
            ...
            // user
            "name", "verified_type", "vtype", "province", "city", "city_level", "gender", "birthyear", "birthdate",
    ...
    public static String[] NEWS_FIELDS = {
            ...
            "source",  "is_recom", "is_top", "is_hot", "is_digest", "sentiment", "keywords", "is_ad", "is_robot", "url"
    };
