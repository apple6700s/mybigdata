...
public abstract class BaseUpdate {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(BaseUpdate.class);
    ...
    protected IWords newKeyWords = null;//需要新添加关键词

    public void setNewKeyWords(IWords newKeyWords) {
     ...
     * @param docs
     */
    protected void sentimentAnaly(List<YZDoc> docs, String fieldKey, SentimentSourceType sentimentSourceType) {
        sentimentAnaly.analysis(keyWords, fieldKey, MigSyncConsts.ES_FIELD_MIG_SENTIMENT, sentimentSourceType, docs);
    }
