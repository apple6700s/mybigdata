...
public abstract class HBaseReader {
    ...
    public Get makeGet(String pk) {
        ...
        } else get.addFamily(family.getBytes());
        return get;
    }

    public Params result2Params(Result result) {
        return new Result2DocMapper(result).map();
    }
    ...
    public List<Params> batchRead(String pk) throws Exception {
        ...
        if (cache.size() >= maxCache) {
            synchronized (this.getClass()) {
                if (cache.size() >= maxCache) {
                    List<Get> glist = new ArrayList<>(cache);
                    cache.clear();
                    return flush(glist);
                }
            }
    ...
    public Params read(Object input) throws Exception {
        String pk = (String) input;
        final Get get = makeGet(pk);
        HTableInterface hTableInterface = HTableInterfacePool.get(getTable());
        try {
            Result result = hTableInterface.get(get);
            Params p = null;
            if (!result.isEmpty()) p = result2Params(result);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] pks = {"0000149269389dd673f2de10e5f5c49d", "000022201a37768de1566f7eaa0012a6", "0000670e283fadd2e3486ffdda6a3433", "000088903a1d71de723e7bd852254193", "000180a7fcabc58ce030e67f6a97b358", "0001b791470a3143b7e1e487f9ee3a3a", "0001c6a5718311b8f0e8c3a0db8ac22d", "00023a9fdc6210022a682872b17486ea", "0002460029f77e60e781d1424f3e60c4", "00029913fb942e25dcb4fed7f9c333a3", "0002d7d7904ae2bb6000dbc10cf1aaa6", "0002ee213770f924558374e07850f93f", "00034fd3b29506b39da6f94c41cfc1df", "0003603dc812bce9ec2eb1c94c8be50a", "0003d26dc2e6b45dfe790a847c71cff6", "0004038f69876a51181e92bc2822265a", "0004311924add5951afd79d266a56f39", "000499b720034ccc9b2ec0d05cf69c57", "0004be1027d16e2cdca29ec44dc39888", "0004d99a7e49b2ef0ba18a42309eb243"};
