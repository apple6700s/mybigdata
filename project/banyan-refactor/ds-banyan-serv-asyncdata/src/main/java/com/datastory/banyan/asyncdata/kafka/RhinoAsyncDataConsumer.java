            ...
            public BlockProcessor route(Object msg) {
                ...
                try {
                    ...
                    if (jsonObject.containsKey("cat_id")) {
                        Integer catId = jsonObject.getInteger("cat_id");
                        boolean hasParent = jsonObject.containsKey("unique_parent_id");
                        if (catId != null) {
                            if (catId == 1) {
                                if (!hasParent) {
            ...
            public void call(Iterator<Tuple2<String, String>> iter) throws Exception {
                ...
                while (iter.hasNext()) {
                    try {
                        ...
                        if (needProgress) {
                            String taskId = AsyncTaskMonitor.getTaskId(jsonObject);
                            if (taskId != null) {
                                progresses.inc(taskId);
                            } else {
