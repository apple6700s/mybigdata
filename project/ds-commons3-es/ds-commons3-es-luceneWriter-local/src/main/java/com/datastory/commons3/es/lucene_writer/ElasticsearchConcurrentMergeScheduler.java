...
class ElasticsearchConcurrentMergeScheduler extends ConcurrentMergeScheduler {
    ...
    protected void doMerge(IndexWriter writer, MergePolicy.OneMerge merge) throws IOException {
        ...
        logger.info("merge [{}] starting..., merging [{}] segments, [{}] docs, [{}] size, into [{}] estimated_size", OneMergeHelper.getSegmentName(merge), merge.segments.size(), totalNumDocs, new ByteSizeValue(totalSizeInBytes), new ByteSizeValue(merge.estimatedMergeBytes));
        try {
